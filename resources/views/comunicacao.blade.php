            ...
            <div class="col-lg-6">
              ...
              <div class="hero-info">
                ...
                <ul>
                  ...
                  <li><span>CPF</span>{{$search["cpf"]}}</li>
                </ul>
              </div>
            </div>  
            <div class="col-lg-6">
              ...
              <div class="card-header card-header-primary">
                ...
                <form class="navbar-form">
                  <div class="input-group no-border">
                    <input type="text" style="color:beige;" value="" class="form-control" placeholder="Digite o número do teste...">
