        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header card-header-primary">
              ...
              <form class="navbar-form" method="get" action={{route('search.paciente')}}>
                <div class="input-group no-border">
                  @csrf
                  <input id="search" name="search" type="text" style="color:beige;" value="" class="form-control" placeholder="Digite o CPF do paciente..." onkeypress="formatar_mascara(this,'###.###.###-##')" maxlength="14">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                          ...
                          <a class="btn btn-secondary" href="{{route('comunicacao.search',['search'=>$info["cpf"]])}}"><i class="material-icons">remove_red_eye</i>Visualizar</a>
